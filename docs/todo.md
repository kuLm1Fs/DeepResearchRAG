...
- [x] 实现多轮检索规划
- [x] 实现补检索循环
- [x] 实现多源对比节点（compare_sources）
- [x] 实现深度自我反思（self_reflect 升级）
- [ ] Prompt 版本化管理（v2）
- [x] 实现历史对话上下文（conversation_history/use_history）
...
- [x] 实现过滤栏（语言、时间、来源、分类）
- [x] 实现多源对比视图
- [x] 实现数据概览仪表盘（Dashboard）
- [x] 实现历史查询记录（HistoryPanel）
